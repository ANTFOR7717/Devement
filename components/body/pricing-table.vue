<template>
  <div class="pricing-table">
    <div class="bg-white border-white border-4 sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
      <div class="px-4 py-4 sm:px-10">
        <div>
          <div class="mb-4 mt-1 grid grid-cols-3 gap-3">
            <div>
              <button @click="standardButton()" :class="button.standard ? 'bg-indigo-500 text-gray-50':'text-gray-500 opacity-50'" class="w-full inline-flex justify-center py-2 px-4 border border-gray-400 rounded-md shadow-sm bg-white text-sm font-medium hover:text-gray-100 hover:bg-indigo-600">
            ...
            <div>
              <button @click="businessButton()" :class="button.business ? 'bg-indigo-500 text-gray-50':'text-gray-500 opacity-50'" class="w-full inline-flex justify-center py-2 px-6 border border-gray-400 rounded-md shadow-sm bg-white text-sm font-medium hover:text-gray-100 hover:bg-indigo-600">
            ...
            <div>
              <button @click="premiumButton()" :class="button.premium ? 'bg-indigo-500 text-gray-50':'text-gray-500 opacity-50'" class="w-full inline-flex justify-center py-2 px-4 border border-gray-400 rounded-md shadow-sm bg-white text-sm font-medium hover:text-gray-100 hover:bg-indigo-600">
      ...
      <div class="px-4 py-6 pt-6 bg-gray-50 border-t-2 border-gray-200 sm:px-10">
        <div class="mb-2.5">
          <button @click="toCreate()" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            Create your account
          </button>
        </div>
        <p class="mt-4 text-xs leading-5 text-gray-500">By signing up, you agree to our <a href="#" class="font-medium text-gray-900 hover:underline">Terms</a>, <a href="#" class="font-medium text-gray-900 hover:underline">Data Policy</a> and <a href="#" class="font-medium text-gray-900 hover:underline">Cookies Policy</a>.</p>
      </div>
    </div>
  </div>
</template>
