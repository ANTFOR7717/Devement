<template>
  <div v-else class="fixed z-10 inset-0 overflow-y-auto">
          ...
          <div class="mt-3 text-center sm:mt-5">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                You're not currently signed in, login now to view your dashboard.
              </p>
            </div>
          </div>
        </div>
        <div class="mt-5 sm:mt-6">
          <nuxt-link type="button" to="/login" class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm">
            Back to login page
          </nuxt-link>
        </div>
      </div>
